export default {
    ...
    getUrlQueryString(url = '', keyToReturn = '') {
    ...
    userMediaIsAvailable() {
        return !!(navigator.getUserMedia || navigator.webkitGetUserMedia || navigator.mozGetUserMedia || navigator.msGetUserMedia);
    },

    getUserFullMedia() {
        if (this.userMediaIsAvailable()) {
    ...
    async setLocalStream(stream, mirrorMode = true) {
        ...
        function drawCanvas(canvas, img) {
            ...
            var imgPixels = ctx.getImageData(0, 0, 320, 320);
            for (var vert = 0; vert < imgPixels.height; vert++) {
                for (var hor = 0; hor < imgPixels.width; hor++) {
                    var i = (vert * 4) * imgPixels.width + hor * 4;
